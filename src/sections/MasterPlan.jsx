...
const STAGES = [
  ...
  },
  {
    ...
    title: 'Buffalo Block',
    status: 'progress',
    text: 'A green shaded area covered with trees for housing buffaloes.',
  },
  {
    tag: '3',
  ...
  {
    tag: '4',
    title: 'Dairy Cows Shed & Milking Parlour',
    status: 'upcoming',
  ...
  },
  {
    ...
    status: 'upcoming',
    text: 'On-farm biogas for heating, electricity and waste-to-value processing.',
  },
  {
    tag: '6',
    title: 'Guest Residences  Upcoming',
    status: 'upcoming',
    text: 'Exclusive on-site accommodation for our lifetime Donors and Project Partners, offering them and their families the opportunity to experience IGA Sial Farm and enjoy authentic village hospitality.',
  },
]
