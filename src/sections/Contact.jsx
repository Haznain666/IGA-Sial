...
const DETAILS = [
  ...
  { icon: Phone, label: 'Phone / WhatsApp', value: '@igsialfarm' },
            ...
            <Reveal>
              ...
              <blockquote className="mt-10 border-l-2 border-gold-400 pl-5 text-cream/80">
                <p className="font-heading italic leading-relaxed">
                  “A heartfelt initiative with a modern vision — a sustainable, scalable charity
                  model that respects the legacy of Iqbal &amp; Ghulam Akbar.”
                </p>
