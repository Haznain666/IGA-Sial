...
const FEATURES = [
  { icon: HeartPulse, title: 'Animal welfare', text: 'Health, welfare, and productivity of your sponsored cow.' },
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <Reveal>
          ...
          <div className="mt-6 space-y-4 text-[17px] leading-relaxed text-cream/80">
            <p>
              Through the Manzil App under development, global Project Partners can sponsor  cows, contribute green-energy solutions, farm equipment, or operations — and track the progress of their contribution.
            </p>
            <p>
              The app provides complete transparency: the health, welfare, and productivity of your sponsored cow, and how the farm’s profits are reinvested into education, jobs, community projects and women’s empowerment.
            </p>
          </div>
