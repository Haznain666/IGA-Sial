      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <Reveal className="order-2 lg:order-1">
          ...
          <div className="mt-6 space-y-4 text-[17px] leading-relaxed text-ink/75">
            <p>
              IGA Sial Farm is a community-first initiative built on compassion, sustainability, and
              modern thinking. Our mission is to support rural families in Punjab, Pakistan by
              transforming traditional dairy farming into a structured, fair, and transparent
              <span className="font-medium text-pine"> “Dairy Farm as a Service” (DFaaS)</span>{' '}
              model.
            </p>
            <p>
              Villagers can lease their cows to the farm and receive stable, guaranteed monthly
              income, while their animals are cared for in a safe, professionally managed
              environment.
            </p>
            <p>
              With 100% of profits reinvested into education, jobs, women’s empowerment, and
              community development, IGA Sial Farm is more than a project — it is a sustainable
              ecosystem designed to uplift generations.
            </p>
          </div>
