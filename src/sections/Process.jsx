...
const STEPS = [
  ...
  },
  {
    ...
    text: 'Through the Manzil App and regular updates, see how your sponsorship improves life of villagers.',
  },
]


const RECEIVE = [
  { icon: Award, text: 'A personalised sponsorship certificate with your cow’s name and photo' },
  { icon: Camera, text: 'Regular photo and welfare updates on your sponsored cow' },
