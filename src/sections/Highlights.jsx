...
const HIGHLIGHTS = [
  ...
  },
  {
    ...
    text: 'Manzil App (under development) lets sponsors track animal welfare, equipments in use, milk production, and impact on the community via other projects/initiatives.',
  },
  {
    icon: GraduationCap,
    title: 'Empowering rural women',
    text: 'Trainings and digital tools let village women take on operations and admin roles while working from the comfort of their home — building real independence."',
  },
